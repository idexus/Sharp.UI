...
namespace CodeMarkup.Maui.Generator.Classes
{
    public class ClassGenerator
    {
        ...
        void SetupContainerIfNeeded()
        {
            ...
            {
                if (!isNewPropertyContainer && mainSymbol.ContainingNamespace.ToDisplayString().Equals("CodeMarkup.Maui"))
                {
        ...
        public void Build()
        {
            ...
            builder.AppendLine("//");
            builder.AppendLine("// <auto-generated> CodeMarkup.Maui.Generator.Classes.Builder");
            builder.AppendLine("//");
            builder.AppendLine();
        ...
        {
            if (mainSymbol.ContainingNamespace.ToDisplayString().Equals("CodeMarkup.Maui"))
                return  $@"using CodeMarkup.Maui;
