...
namespace CodeMarkup.Maui.Generator.Extensions
{
    public partial class ExtensionGenerator
    {
        ...
        public void Build()
        {
            ...
            builder.AppendLine("//");
            builder.AppendLine("// <auto-generated> CodeMarkup.Maui.Generator.Extensions.Builder");
            builder.AppendLine("//");
            builder.AppendLine();
    ...
    ";
        ...
        void GenerateExtensionNameSpace()
        {
            ...
            builder.Append($@"
namespace {(mainSymbol.ContainingNamespace.ToDisplayString().StartsWith("Microsoft.Maui") ? "CodeMarkup.Maui" : mainSymbol.ContainingNamespace.ToDisplayString())}
{{
