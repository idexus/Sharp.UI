...
namespace Sharp.UI
{
    ...
    public static partial class PageExtension
    {
        ...
        public static T Padding<T>(this T self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.Page
        {
            self.SetValue(Microsoft.Maui.Controls.Page.PaddingProperty, new Thickness(horizontalSize, verticalSize));
            return self;
        }
        ...
        public static SettersContext<T> Padding<T>(this SettersContext<T> self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.Page
        {
            self.XamlSetters.Add(new Setter { Property = Microsoft.Maui.Controls.Page.PaddingProperty, Value = new Thickness(horizontalSize, verticalSize) });
            return self;
        }
