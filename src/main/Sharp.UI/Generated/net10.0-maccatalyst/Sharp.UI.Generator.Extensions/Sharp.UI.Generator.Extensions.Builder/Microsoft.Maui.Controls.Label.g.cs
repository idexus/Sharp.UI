...
namespace Sharp.UI
{
    ...
    public static partial class LabelExtension
    {
        ...
        public static T Padding<T>(this T self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.Label
        {
            self.SetValue(Microsoft.Maui.Controls.Label.PaddingProperty, new Thickness(horizontalSize, verticalSize));
            return self;
        }
        ...
        public static T Padding<T>(this T self, double left, double top, double right, double bottom)
            where T : Microsoft.Maui.Controls.Label
        {
            self.SetValue(Microsoft.Maui.Controls.Label.PaddingProperty, new Thickness(left, top, right, bottom));
            return self;
        }
...
#nullable enable
        ...
        public static SettersContext<T> Padding<T>(this SettersContext<T> self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.Label
        {
            self.XamlSetters.Add(new Setter { Property = Microsoft.Maui.Controls.Label.PaddingProperty, Value = new Thickness(horizontalSize, verticalSize) });
            return self;
        }
        ...
        public static SettersContext<T> Padding<T>(this SettersContext<T> self, double left, double top, double right, double bottom)
            where T : Microsoft.Maui.Controls.Label
        {
            self.XamlSetters.Add(new Setter { Property = Microsoft.Maui.Controls.Label.PaddingProperty, Value = new Thickness(left, top, right, bottom) });
            return self;
        }
