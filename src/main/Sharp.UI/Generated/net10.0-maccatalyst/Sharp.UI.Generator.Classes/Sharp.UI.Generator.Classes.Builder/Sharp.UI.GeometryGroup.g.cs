...
namespace Sharp.UI
{
    ...
    public partial class GeometryGroup : IList<Microsoft.Maui.Controls.Shapes.Geometry>
	{
        ...
        public GeometryGroup(System.Func<GeometryGroup, GeometryGroup> configure) 
        {
            configure(this);
        }

        public GeometryGroup(out GeometryGroup geometryGroup, System.Func<GeometryGroup, GeometryGroup> configure) 
        {
            geometryGroup = this;
            configure(this);
        }
        ...
        public void SetItems(params Microsoft.Maui.Controls.Shapes.Geometry[] items)
        {
            this.Clear();
