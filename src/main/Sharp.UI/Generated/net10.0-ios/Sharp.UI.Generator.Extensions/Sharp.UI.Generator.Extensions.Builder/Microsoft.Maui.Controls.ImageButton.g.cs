...
namespace Sharp.UI
{
    ...
    public static partial class ImageButtonExtension
    {
        ...
        public static T Padding<T>(this T self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.ImageButton
        {
            self.SetValue(Microsoft.Maui.Controls.ImageButton.PaddingProperty, new Thickness(horizontalSize, verticalSize));
            return self;
        }
        ...
        public static SettersContext<T> Padding<T>(this SettersContext<T> self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.ImageButton
        {
            self.XamlSetters.Add(new Setter { Property = Microsoft.Maui.Controls.ImageButton.PaddingProperty, Value = new Thickness(horizontalSize, verticalSize) });
            return self;
        }
