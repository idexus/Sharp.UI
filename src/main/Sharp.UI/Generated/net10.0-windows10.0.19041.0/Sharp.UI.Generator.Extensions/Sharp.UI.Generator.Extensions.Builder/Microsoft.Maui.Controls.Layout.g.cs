...
namespace Sharp.UI
{
    ...
    public static partial class LayoutExtension
    {
        ...
        public static T Padding<T>(this T self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.Layout
        {
            self.SetValue(Microsoft.Maui.Controls.Layout.PaddingProperty, new Thickness(horizontalSize, verticalSize));
            return self;
        }
        ...
        public static SettersContext<T> Padding<T>(this SettersContext<T> self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.Layout
        {
            self.XamlSetters.Add(new Setter { Property = Microsoft.Maui.Controls.Layout.PaddingProperty, Value = new Thickness(horizontalSize, verticalSize) });
            return self;
        }
