...
#nullable enable
        ...
        public static SettersContext<T> Padding<T>(this SettersContext<T> self, double horizontalSize, double verticalSize)
            where T : Microsoft.Maui.Controls.Button
        {
            self.XamlSetters.Add(new Setter { Property = Microsoft.Maui.Controls.Button.PaddingProperty, Value = new Thickness(horizontalSize, verticalSize) });
            return self;
        }
        ...
        public static SettersContext<T> Padding<T>(this SettersContext<T> self, double left, double top, double right, double bottom)
            where T : Microsoft.Maui.Controls.Button
        {
            self.XamlSetters.Add(new Setter { Property = Microsoft.Maui.Controls.Button.PaddingProperty, Value = new Thickness(left, top, right, bottom) });
            return self;
        }
