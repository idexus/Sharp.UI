...
namespace Sharp.UI
{
    ...
    public static partial class NavigableElementExtension
    {
        ...
        public static T Navigation<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.NavigableElement
        {
            obj.SetValueOrSetter(Microsoft.Maui.Controls.NavigableElement.NavigationProperty, navigation);
            return obj;
        }
            ...
            where T : Microsoft.Maui.Controls.NavigableElement
        {
            ...
            if (builder.ValueIsSet()) obj.SetValueOrSetter(Microsoft.Maui.Controls.NavigableElement.NavigationProperty, builder.GetValue());
            return obj;
        }
        ...
        public static T Navigation<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.NavigableElement
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.NavigableElement.NavigationProperty));
            builder.BindProperty();
            return obj;
        }
        ...
        public static T Style<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.NavigableElement
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.NavigableElement.StyleProperty));
            builder.BindProperty();
            return obj;
        }
