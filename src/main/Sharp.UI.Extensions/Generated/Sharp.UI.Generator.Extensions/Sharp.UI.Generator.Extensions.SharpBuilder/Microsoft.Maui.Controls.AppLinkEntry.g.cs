...
namespace Sharp.UI
{
    ...
    public static partial class AppLinkEntryExtension
    {
        ...
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.AppLinkUriProperty, appLinkUri);
            return self;
        }
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            ...
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.AppLinkUriProperty, builder.GetValue());
            return self;
        }
        ...
        public static T Description<T>(this T self,
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.DescriptionProperty, description);
            return self;
        }
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            ...
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.DescriptionProperty, builder.GetValue());
            return self;
        }
        ...
        public static T IsLinkActive<T>(this T self,
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.IsLinkActiveProperty, isLinkActive);
            return self;
        }
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            ...
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.IsLinkActiveProperty, builder.GetValue());
            return self;
        }
        ...
        public static T Thumbnail<T>(this T self,
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.ThumbnailProperty, thumbnail);
            return self;
        }
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            ...
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.ThumbnailProperty, builder.GetValue());
            return self;
        }
        ...
        public static T Title<T>(this T self,
            ...
            where T : Microsoft.Maui.Controls.AppLinkEntry
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.TitleProperty, title);
            return self;
        }
        ...
        {
            var builder = buildValue(new ValueBuilder<string>());
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.AppLinkEntry.TitleProperty, builder.GetValue());
            return self;
        }
