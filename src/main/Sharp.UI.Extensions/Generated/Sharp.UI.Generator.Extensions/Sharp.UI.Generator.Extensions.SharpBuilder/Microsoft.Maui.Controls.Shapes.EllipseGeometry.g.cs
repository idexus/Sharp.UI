...
namespace Sharp.UI
{
    ...
    public static partial class EllipseGeometryExtension
    {
        ...
        public static T Center<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.Shapes.EllipseGeometry
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.Shapes.EllipseGeometry.CenterProperty));
            builder.BindProperty();
            return obj;
        }
        ...
        public static T RadiusX<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.Shapes.EllipseGeometry
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.Shapes.EllipseGeometry.RadiusXProperty));
            builder.BindProperty();
            return obj;
        }
        ...
        public static T RadiusY<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.Shapes.EllipseGeometry
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.Shapes.EllipseGeometry.RadiusYProperty));
            builder.BindProperty();
            return obj;
        }
