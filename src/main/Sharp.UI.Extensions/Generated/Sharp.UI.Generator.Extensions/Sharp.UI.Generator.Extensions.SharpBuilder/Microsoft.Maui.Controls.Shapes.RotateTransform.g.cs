...
namespace Sharp.UI
{
    ...
    public static partial class RotateTransformExtension
    {
        ...
        public static T Angle<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.Shapes.RotateTransform
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.Shapes.RotateTransform.AngleProperty));
            builder.BindProperty();
            return obj;
        }
        ...
        public static T CenterX<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.Shapes.RotateTransform
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.Shapes.RotateTransform.CenterXProperty));
            builder.BindProperty();
            return obj;
        }
        ...
        public static T CenterY<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.Shapes.RotateTransform
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.Shapes.RotateTransform.CenterYProperty));
            builder.BindProperty();
            return obj;
        }
