...
namespace Sharp.UI
{
    ...
    public static partial class SelectableItemsViewExtension
    {
        ...
        public static T SelectionMode<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.SelectableItemsView
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.SelectableItemsView.SelectionModeProperty));
            builder.BindProperty();
            return obj;
        }
        ...
        public static T SelectedItems<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.SelectableItemsView
        {
            obj.SetValueOrSetter(Microsoft.Maui.Controls.SelectableItemsView.SelectedItemsProperty, selectedItems);
            return obj;
        }
        ...
        {
            var builder = buidValue(new ValueBuilder<object>());
            if (builder.ValueIsSet()) obj.SetValueOrSetter(Microsoft.Maui.Controls.SelectableItemsView.SelectedItemsProperty, builder.GetValue());
            return obj;
        }
        ...
        public static T SelectedItems<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.SelectableItemsView
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.SelectableItemsView.SelectedItemsProperty));
            builder.BindProperty();
            return obj;
        }
        
        public static T SelectionChangedCommand<T>(this T obj,
            object selectionChangedCommand)
            where T : Microsoft.Maui.Controls.SelectableItemsView
        {
            obj.SetValueOrSetter(Microsoft.Maui.Controls.SelectableItemsView.SelectionChangedCommandProperty, selectionChangedCommand);
            return obj;
        ...
        public static T SelectionChangedCommand<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.SelectableItemsView
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.SelectableItemsView.SelectionChangedCommandProperty));
            builder.BindProperty();
            return obj;
        }
