...
namespace Sharp.UI
{
    ...
    public static partial class GridItemsLayoutExtension
    {
        ...
        public static T Span<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.GridItemsLayout
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.GridItemsLayout.SpanProperty));
            builder.BindProperty();
            return obj;
        }
        
        public static T VerticalItemSpacing<T>(this T obj,
            object verticalItemSpacing)
            where T : Microsoft.Maui.Controls.GridItemsLayout
        {
            obj.SetValueOrSetter(Microsoft.Maui.Controls.GridItemsLayout.VerticalItemSpacingProperty, verticalItemSpacing);
            return obj;
        ...
        public static T VerticalItemSpacing<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.GridItemsLayout
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.GridItemsLayout.VerticalItemSpacingProperty));
            builder.BindProperty();
            return obj;
        }
        
        public static T HorizontalItemSpacing<T>(this T obj,
            object horizontalItemSpacing)
            where T : Microsoft.Maui.Controls.GridItemsLayout
        {
            obj.SetValueOrSetter(Microsoft.Maui.Controls.GridItemsLayout.HorizontalItemSpacingProperty, horizontalItemSpacing);
            return obj;
        ...
        public static T HorizontalItemSpacing<T>(this T obj,
            ...
            where T : Microsoft.Maui.Controls.GridItemsLayout
        {
            var builder = buidBinding(new BindingBuilder<object>(obj, Microsoft.Maui.Controls.GridItemsLayout.HorizontalItemSpacingProperty));
            builder.BindProperty();
            return obj;
        }
