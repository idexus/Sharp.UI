...
namespace Sharp.UI
{
    ...
    public static partial class LayoutExtension
    {
        ...
        public static T IsClippedToBounds<T>(this T self,
            ...
            where T : Microsoft.Maui.Controls.Layout
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.Layout.IsClippedToBoundsProperty, isClippedToBounds);
            return self;
        }
            ...
            where T : Microsoft.Maui.Controls.Layout
        {
            ...
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.Layout.IsClippedToBoundsProperty, builder.GetValue());
            return self;
        }
        ...
        public static T Padding<T>(this T self,
            ...
            where T : Microsoft.Maui.Controls.Layout
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.Layout.PaddingProperty, padding);
            return self;
        }
            ...
            where T : Microsoft.Maui.Controls.Layout
        {
            ...
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.Layout.PaddingProperty, builder.GetValue());
            return self;
        }
        ...
        public static T CascadeInputTransparent<T>(this T self,
            ...
            where T : Microsoft.Maui.Controls.Layout
        {
            self.SetValueOrSetter(Microsoft.Maui.Controls.Layout.CascadeInputTransparentProperty, cascadeInputTransparent);
            return self;
        }
        ...
        {
            var builder = buildValue(new ValueBuilder<bool>());
            if (builder.ValueIsSet()) self.SetValueOrSetter(Microsoft.Maui.Controls.Layout.CascadeInputTransparentProperty, builder.GetValue());
            return self;
        }
