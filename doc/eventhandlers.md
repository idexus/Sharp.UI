...
In Maui, you can add functionality to user interface controls by handling events. For each `EventHandler` in a `Sharp.UI` class, a fluent helper method is generated to make it easier to attach an event handler to the control.
