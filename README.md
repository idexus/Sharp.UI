...
- using Visual Studio 2022 for Mac with Sharp.UI Hot Reload extension [Sharp.UI.HotReloadExt.Mac_0.1.7.mpack](https://github.com/idexus/Sharp.UI/releases/tag/0.2.3-alpha.18) (supports only desktop apps)
