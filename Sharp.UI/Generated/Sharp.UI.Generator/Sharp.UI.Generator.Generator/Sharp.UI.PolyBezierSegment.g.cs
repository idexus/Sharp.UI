...
{  
    /// <summary>
    /// A <c>Sharp.UI</c> class wrapper from the sealed <c>Microsoft.Maui.Controls.Shapes.PolyBezierSegment</c> class.
    /// Use the <value>MauiObject</value> property to get the raw Maui object.
    /// </summary>
    public partial class PolyBezierSegment : Sharp.UI.IPolyBezierSegment, IMauiWrapper, ISealedMauiWrapper
    {
        // ----- maui object -----

        public object _maui_RawObject { get; set; }

        public Microsoft.Maui.Controls.Shapes.PolyBezierSegment MauiObject { get => (Microsoft.Maui.Controls.Shapes.PolyBezierSegment)_maui_RawObject; protected set => _maui_RawObject = value; }

        // ----- constructors -----

        public PolyBezierSegment(Microsoft.Maui.Controls.Shapes.PolyBezierSegment polyBezierSegment)
        {
