...
{  
    /// <summary>
    /// A <c>Sharp.UI</c> class wrapper from the sealed <c>Microsoft.Maui.Controls.TapGestureRecognizer</c> class.
    /// Use the <value>MauiObject</value> property to get the raw Maui object.
    /// </summary>
    public partial class TapGestureRecognizer : Sharp.UI.ITapGestureRecognizer, IMauiWrapper, ISealedMauiWrapper
    {
        // ----- maui object -----

        public object _maui_RawObject { get; set; }

        public Microsoft.Maui.Controls.TapGestureRecognizer MauiObject { get => (Microsoft.Maui.Controls.TapGestureRecognizer)_maui_RawObject; protected set => _maui_RawObject = value; }

        // ----- constructors -----

        public TapGestureRecognizer(Microsoft.Maui.Controls.TapGestureRecognizer tapGestureRecognizer)
        {
        ...
        public object? CommandParameter { get => MauiObject.CommandParameter; set => MauiObject.CommandParameter = MauiWrapper.Value<object>(value); }
