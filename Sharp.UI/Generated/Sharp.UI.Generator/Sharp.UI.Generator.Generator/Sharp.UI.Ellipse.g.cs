...
{  
    /// <summary>
    /// A <c>Sharp.UI</c> class wrapper from the sealed <c>Microsoft.Maui.Controls.Shapes.Ellipse</c> class.
    /// Use the <value>MauiObject</value> property to get the raw Maui object.
    /// </summary>
    public partial class Ellipse : Sharp.UI.IEllipse, IMauiWrapper, ISealedMauiWrapper
    {
        // ----- maui object -----

        public object _maui_RawObject { get; set; }

        public Microsoft.Maui.Controls.Shapes.Ellipse MauiObject { get => (Microsoft.Maui.Controls.Shapes.Ellipse)_maui_RawObject; protected set => _maui_RawObject = value; }
        ...
        public Ellipse(System.Action<Ellipse> configure) : this()
        {
            configure(this);
        }

        public Ellipse(out Ellipse ellipse, System.Action<Ellipse> configure) : this()
        {
            ellipse = this;
            configure(this);
        }
        ...
        public static implicit operator Microsoft.Maui.Controls.Shapes.Ellipse(Ellipse obj) => obj.MauiObject;
