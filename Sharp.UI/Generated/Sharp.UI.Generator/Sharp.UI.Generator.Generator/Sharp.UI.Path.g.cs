...
{  
    /// <summary>
    /// A <c>Sharp.UI</c> class wrapper from the sealed <c>Microsoft.Maui.Controls.Shapes.Path</c> class.
    ...
    public partial class Path : Sharp.UI.IPath, IMauiWrapper, ISealedMauiWrapper, IEnumerable
    {
        ...
        public static implicit operator Microsoft.Maui.Controls.Shapes.Path(Path obj) => obj.MauiObject;
        ...
        public Microsoft.Maui.Controls.Shapes.Geometry Data { get => MauiObject.Data; set => MauiObject.Data = value; }
        public Microsoft.Maui.Controls.Shapes.Transform RenderTransform { get => MauiObject.RenderTransform; set => MauiObject.RenderTransform = value; }
